package com.D5Power.mission
{
	...
	public class NPCMissionConfig
	{
		 ...
		 * 设置NPC事件
		 */ 
		NSD5Power function _setEvent(type:String,value:String):void
		{
		...
		NSD5Power function set _say(s:String):void
		{
			_say = s;
		}
		
		NSD5Power function set _npcname(s:String):void
		{
			_npcname = s;
		}
		
		NSD5Power function addMission(id:uint,data:Object):MissionData
		{
		...
		NSD5Power function getMission(id:uint):MissionData
		{
			if(_nowFind!=id)
			{
